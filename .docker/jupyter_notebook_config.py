...
#  otherwise.
#  Default: {}
c.NotebookApp.terminado_settings = {"shell_command": ["/usr/bin/zsh", "--login", "-i"]}  # type: ignore
...
#  Choices: any of ['sha1', 'sha384', 'blake2s', 'blake2b', 'sha256', 'sha3_256', 'sha3_512', 'sha3_224', 'sha224', 'md5', 'sha3_384', 'sha512']
#  Default: 'sha256'
