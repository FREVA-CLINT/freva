...
class UserCrawl(models.Model):
    ...
    STATUS = [('waiting', 'waiting'), ('crawling', 'crawling'), ('ingesting', 'ingesting'), ('success', 'success'),
              ('failed', 'failed')]

    created = models.DateTimeField(auto_now_add=True)
    status = models.CharField(max_length=10, choices=STATUS)
    user = models.ForeignKey(User,on_delete=models.CASCADE)  # Modified 10-05-2021 Mahesh
