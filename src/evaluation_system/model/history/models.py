...
>>>>>>> 81c110359437db30b277393ced3cb5fc272a71ba
    ...
    #: User ID
<<<<<<< HEAD
    uid = models.ForeignKey(User, on_delete=models.CASCADE,to_field='username', db_column='uid')
=======
    uid = models.ForeignKey(User,on_delete=models.CASCADE,to_field='username', db_column='uid')
>>>>>>> 81c110359437db30b277393ced3cb5fc272a71ba
...
class HistoryTag(models.Model):
    ...
    uid = models.ForeignKey(User,on_delete=models.CASCADE,to_field='username', db_column='uid', null=True, default=None)
...
class Configuration(models.Model):
    ...
    #: history id
<<<<<<< HEAD
    history_id = models.ForeignKey(History, on_delete=models.CASCADE,related_name='history_id')
    
    #: parameter number
    parameter_id = models.ForeignKey(Parameter,on_delete=models.CASCADE, related_name='parameter_id')
=======
    history_id = models.ForeignKey(History,on_delete=models.CASCADE,related_name='history_id')
