...
class DRSFile(object):
    ...
    DRS_STRUCTURE = {
        #Cmip5 data
        CMIP5 : {
         "root_dir":"/kp/kp06/integra/data4dwd/model/global",
        ...
        OBSERVATIONS : {
         "root_dir":"/kp/kp06/integra/data4dwd",
        ...
        #project data
        PROJECTDATA : {
         "root_dir":"/kp/kp06/integra/data4dwd/projectdata",
...
"""
    ...
    def __init__(self, file_dict=None, drs_structure=CMIP5):
...
"""
    ...
    @staticmethod
    def _getDrsStructure(drs_structure=CMIP5):
        """
...
"""
    ...
    @staticmethod
    def from_dict(file_dict, drs_structure=CMIP5):
...
:returns: (:class:`DRSFile`) generated from the given dictionary and DRS structure name"""
    ...
    @staticmethod
    def from_json(json_str, drs_structure=CMIP5):
...
:returns: (:class:`DRSFile`) generated from the given dictionary and DRS structure name"""
    ...
    @staticmethod
    def search(drs_structure=CMIP5, latest_version=True, path_only=False, **partial_dict):
