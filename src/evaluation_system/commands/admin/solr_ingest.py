...
'''
solr_ingest -- manage craling and ingesting files
...
from evaluation_system.commands import BaseCommand, CommandError, FrevaBaseCommand
...
class Command(FrevaBaseCommand):
    ...
    _args = [
             ...
             {'name':'--batch-size','help':'Number of entries to send at the same time to Solr.', 'type':'int', 'metavar':'N', 'default':10000},
